...
def _sign(sk: ec.EllipticCurvePrivateKey, *, body: bytes = BODY, created: int = CREATED) -> dict[str, str]:
    ...
    r, s = decode_dss_signature(sk.sign(base.encode(), ec.ECDSA(hashes.SHA256())))
