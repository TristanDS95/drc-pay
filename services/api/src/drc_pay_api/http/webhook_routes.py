"""HTTP transport for pawaPay's signed callbacks — pawaPay POSTs the final deposit /
payout / refund outcome here. The route reads the raw body + headers and delegates to the
application service; a bad signature is a 401, everything else returns 200 with a status.
"""
